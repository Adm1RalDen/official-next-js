...
export const ProjectData: ProjectProps = {
  technologies: ['PHP', 'Zend framework', 'JavaScript', 'JQuery', 'MySql', 'Smarty', 'Ajax', 'Apache','Rest API'],
  title: "Mdina Glass",
  ...
  description: "The Mdina Glass website was designed for Mdina Glass to sell their products worldwide. Users of the site can get information about products, create your account, place an order.",
